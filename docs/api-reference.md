---
title: Ralph SDK API reference
description: Auto-generated reference for every public function, class, and constant in the Ralph Python SDK (17 modules, 88 public symbols).
audience: [integrator, contributor]
diataxis: reference
last_reviewed: 2026-04-23
generator: docs-mcp docs_generate_api
---

# Ralph SDK API reference

> **Auto-generated.** This reference is regenerated by `docs_generate_api` from [`sdk/ralph_sdk/`](../sdk/ralph_sdk/) source files. Hand edits in sections below the TOC are overwritten on next generation. Regenerate after SDK changes; see [CONTRIBUTING.md](../CONTRIBUTING.md#documentation-requirements).

For narrative walkthroughs, examples, and design rationale, start with [sdk-guide.md](sdk-guide.md) instead. For architecture overview, see [ARCHITECTURE.md](ARCHITECTURE.md).

## Modules

17 public modules covering the async agent loop, circuit breaker, cost tracking, memory, parsing, plan optimization, and state. Full source in [`sdk/ralph_sdk/`](../sdk/ralph_sdk/).
...
Provides dual-mode operation: standalone CLI + TheStudio embedded. See [sdk-guide.md](sdk-guide.md) for usage and [ADR-0005](decisions/0005-bash-sdk-duality.md) for design rationale.
