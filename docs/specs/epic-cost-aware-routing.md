...
| [COSTROUTE-3](story-costroute-3-prompt-cache-optimization.md) | Prompt Structure Optimization for Cache Hits | High | Small | **Reverted** (shipped without a runtime caller in linear mode; flag + functions removed) |
